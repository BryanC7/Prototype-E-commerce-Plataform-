...
productosAdmin.addEventListener('click', editarProductos)

function imprimirProducto() {
    productos.forEach(producto => {
        const card = document.createElement('div')
        card.classList.add('my-2','mx-auto','px-0','py-0','col-xl-2','col-lg-3','col-md-3','col-md-4','col-sm-4', 'col-10')
        card.innerHTML = 
        `
        <div class="card">
            ...
            <div class="card-img-overlay ">
                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                    ...
                    <button type="button" class="btn boton-editar btn-outline-primary btn-light iconos-img" id="${producto.id}">
                    ...
                    <button type="button" class="btn boton-eliminar btn-outline-primary btn-light iconos-img" id="${producto.id}">
